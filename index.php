		...
		<div class="row text-center">
			<div class="col-md-4">
				<div class="col editContent">
					...
					<h3 class="numbertext">Do You Have An Account?</h3>
					<p>
			...
			<div class="col-md-4 editContent">
				<div class="col">
					...
					<h3 class="numbertext">View Employee Salary Report</h3>
					<p>
						 Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Nullam quis risus eget urna mollis ornare vel eu leo. Cras justo odio, dapibus ac facilisis in, egestas eget quam.
					</p>
				</div>
...
<div class="item content">
	<div class="container text-center">
		<a href="login.php" class="homebrowseitems">LOGIN
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="infoareawrap">
					<h1 class="text-center subtitle">Human Resource Support</h1>
					<p>
